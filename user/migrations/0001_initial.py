    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portrait', models.FileField(blank=True, null=True, upload_to='pic')),
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='info', to=settings.AUTH_USER_MODEL, verbose_name='所属账户')),
            ],
            options={
                'db_table': 'userinfo',
                'managed': True,
